...
export default function App() {
  ...
  const ls = localStorage.fav || "[]";
  const [fav, setfav] = useState<number[]>(JSON.parse(ls));
  const ToggleFavEvent = (st: number[]) => {
    setfav(st);
  ...
  const favproviderValue: favContextInterface = { fav, ToggleFavEvent };
  return (
